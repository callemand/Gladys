...
class SettingsSystemHostPower extends Component {
  ...
  render({ systemInfos }, { pendingAction, actionSent, error, errorDetail }) {
    // We only know the availability once systemInfos has been loaded.
    const available = systemInfos ? systemInfos.host_power_management_available === true : true;
        ...
        <div class="card-body">
          ...
          {pendingAction ? (
            <div>
              ...
              <button onClick={this.confirm} class="btn btn-primary mr-2">
                <Text id="systemSettings.confirm" />
              </button>
              <button onClick={this.cancel} class="btn btn-danger">
            ...
            <Localizer>
              ...
              >
                <button onClick={this.askConfirmation('reboot')} disabled={disabled} class="btn btn-warning mr-2">
